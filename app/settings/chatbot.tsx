...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingTop: 10, paddingBottom: 15, paddingHorizontal: 20, backgroundColor: '#2D144B' },
  backBtn: { padding: 10, marginLeft: -10 },
  backBtnText: { color: '#E0BBE4', fontSize: 18 },
  ...
  userBubble: { alignSelf: 'flex-end', backgroundColor: '#4B2A6B', borderBottomRightRadius: 5 },
  aiBubble: { alignSelf: 'flex-start', backgroundColor: '#3D1B5D', borderBottomLeftRadius: 5 },
  messageText: { color: '#fff', fontSize: 16, lineHeight: 24 },
  inputArea: { flexDirection: 'row', padding: 15, backgroundColor: '#2D144B', alignItems: 'center' },
  input: { flex: 1, backgroundColor: '#1A0B2E', color: '#fff', padding: 15, borderRadius: 25, fontSize: 16, marginRight: 10, borderWidth: 1, borderColor: '#3D1B5D' },
  sendBtn: { backgroundColor: '#E0BBE4', paddingVertical: 12, paddingHorizontal: 20, borderRadius: 25 },
  sendBtnText: { color: '#1A0B2E', fontWeight: 'bold', fontSize: 16 },
  warningBanner: {
